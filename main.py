...
def main():
    ...
    while True:
        ...
        print("A bola foi interceptada em ", ponto_interceptacao['t'], "segundos, nas coordenadas: X = ", round(ponto_interceptacao['x_bola'], 2), "e Y = ", round(ponto_interceptacao['y_bola'], 2))
